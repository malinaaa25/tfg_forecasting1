...
if st.sidebar.button('CALCULATE FORECAST'):   # Solamente se ejecuta cuando el usuario hace click en el botón
    ...
    st.write("The information regarding the solar plant and weather forecast it's already uploaded and it's broken down by hours. The variables used from the solar field platform are:")
